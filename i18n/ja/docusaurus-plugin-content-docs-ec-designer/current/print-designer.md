...
* **カテゴリー / サブカテゴリー**: 商品を特定のセクションごとに整理・分類するために使用されます。
* **アプリ名**: 使用するデザイナーの種類を指します（例：プリントデザイナー、フォトブックデザイナーなど）。
* **印刷面**: デザインを作成するためのデザイナー上の作業領域（印刷対象の面）です。
* **出力タイプ**: 注文後に生成される出力ファイル形式（JPEG または PDF）です。
* **最小ページ数 / 最大ページ数**: 商品で設定可能な最小および最大のページ数です。
