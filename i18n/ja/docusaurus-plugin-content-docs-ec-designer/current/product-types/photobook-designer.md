...
* ウェブサイトを開き、有効なログイン情報を入力して「ログイン」ボタンをクリックします。
...
* ダッシュボードのホームページが表示されます。



**ステップ 3：現在のテンプレートのテンプレートダッシュボードを表示**



![](/img/ptc2.png)

* 「テンプレート」をクリックして、既存のテンプレート一覧を読み込みます。
...
* 「新しいグループを作成」\*\*ボタンをクリックして、空の新しいテンプレートを作成します。


* ![](/img/ptc5.png)
* 最初のステップは、ユーザーが空のテンプレートを作成し、デザインして保存することです。

  **テンプレートグループ**とは、1つのテンプレートを作成した後、同じテンプレートを他の利用可能なサイズや向きにリサイズでき、再度開くとこの基本テンプレートの下に表示される仕組みを指します。
* **注意：** 既存のテンプレートデザインは複数の製品サイズにリサイズ可能です。

  そのようなテンプレートは、すべてのリサイズされた製品サイズを元のテンプレートの下に表示し、編集や公開などの参照用にグループ化されます。

  **注意：** リサイズされたテンプレートは、元のテンプレートの下にグループとして表示されます。
